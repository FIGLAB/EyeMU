...
//                console.log(event);
                ...
                z_delta = (rotateDegrees-Z_baseline);
                fb_delta = (frontToBack-FB_baseline);
                lr_delta = (leftToRight-LR_baseline);
...
function orientationCheckContinuous(){
    ...
    setTimeout(orientationCheckContinuous, 1000);
}